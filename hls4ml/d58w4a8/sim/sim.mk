...
INCDIR += -I$(MODEL_DIR)/src/firmware
INCDIR += -I$(MODEL_DIR)/src/firmware/ac_math/include
INCDIR += -I$(MODEL_DIR)/src/firmware/ac_types/include
INCDIR += -I$(MODEL_DIR)/src/firmware/ac_simutils/include
INCDIR += -I$(MODEL_DIR)/src/firmware/weights
INCDIR += -I$(MODEL_DIR)/src/firmware/nnet_utils
...
VPATH :=
VPATH += $(MODEL_DIR)/tb
VPATH += $(MODEL_DIR)/src/firmware
VPATH += $(MODEL_DIR)/src/firmware/weights
#VPATH += ../$(MODEL_DIR)/nnet_utils

CXX_SOURCES :=
CXX_SOURCES += $(subst $(MODEL_DIR)/tb/,,$(wildcard $(MODEL_DIR)/tb/*.cpp))
CXX_SOURCES += $(subst $(MODEL_DIR)/src/firmware/,,$(wildcard $(MODEL_DIR)/src/firmware/*.cpp))
