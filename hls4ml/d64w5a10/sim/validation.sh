...
for l in `seq 0 11`; do
    ...
    for i in `seq 0 9`; do
        ...
        rm -f weights/w2.txt
        ln -s ../../../../weights_txt/d64w5a10/y_local_$l/iter_$i/w2.txt weights/w2.txt
        rm -f weights/b2.txt
        ln -s ../../../../weights_txt/d64w5a10/y_local_$l/iter_$i/b2.txt weights/b2.txt

        rm -f weights/w5.txt
        ln -s ../../../../weights_txt/d64w5a10/y_local_$l/iter_$i/w5.txt weights/w5.txt
        rm -f weights/b5.txt
        ln -s ../../../../weights_txt/d64w5a10/y_local_$l/iter_$i/b5.txt weights/b5.txt
