...
switch $opt(version) {
    "v01" {
        ...
        solution design set nnet::relu<ac_fixed<10,5,true,AC_RND_CONV,AC_SAT>,ac_fixed<8,0,false,AC_RND_CONV,AC_SAT>,relu_config4> -inline
        solution design set nnet::dense<ac_fixed<6,6,false,AC_TRN,AC_WRAP>,ac_fixed<10,5,true,AC_TRN,AC_WRAP>,config2> -inline
        solution design set nnet::dense<ac_fixed<8,0,false,AC_RND_CONV,AC_SAT>,ac_fixed<10,4,true,AC_TRN,AC_WRAP>,config6> -inline
    }
    "v02" {
        solution design set myproject -top
        solution design set ac::fx_div<8> -inline
